...
const Header = ({expanded, name, toggleExpand,children,isWhiteListed,setWhiteListPending}) => {
    if(isWhiteListed){
        ...
        return (
            <div key={name} className="bg-light border d-flex">
                ...
                <i className="fa fa-lg fa-minus-square px-2 py-2" onClick={whiteList} aria-hidden="true"/>
            </div>
        )
    } else {
        return null
