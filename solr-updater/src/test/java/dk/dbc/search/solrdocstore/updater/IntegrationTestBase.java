    ...
    private static GenericContainer makeSolr() {
        ...
        ImageFromDockerfile image = new ImageFromDockerfile()
                ...
                .withDockerfileFromBuilder(dockerfile ->
                        dockerfile.from("docker-de.artifacts.dbccloud.dk/dbc-solr8-replica-searcher")
                                .copy("target/solr/corepo-config", "/opt/solr/server/solr/corepo-1/conf/")
                                .copy("target/solr/corepo-1/core.properties", "/opt/solr/server/solr/corepo-1/core.properties")
                                .copy("target/solr/corepo-config", "/opt/solr/server/solr/corepo-2/conf/")
                                .copy("target/solr/corepo-2/core.properties", "/opt/solr/server/solr/corepo-2/core.properties")
                                .user("root")
