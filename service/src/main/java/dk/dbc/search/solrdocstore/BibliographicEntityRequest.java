...
public class BibliographicEntityRequest extends BibliographicEntity {
    ...
    public BibliographicEntityRequest(int agencyId, String bibliographicRecordId, String work, String unit, String producerVersion, boolean deleted, Map<String, List<String>> indexKeys, String trackingId, List<String> superceds, Integer commitWithin) {
        super(agencyId, bibliographicRecordId, work, unit, producerVersion, deleted, indexKeys, trackingId);
