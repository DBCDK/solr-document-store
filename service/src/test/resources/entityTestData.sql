...
INSERT INTO holdingsitemssolrkeys (AGENCYID, BIBLIOGRAPHICRECORDID, INDEXKEYS, TRACKINGID)
     VALUES ( 300, '4321', '[{"id": ["argle"], "title": ["unix bogen"]}, {"id": ["argle"], "dyr": ["hest"], "title": ["unix bogen"]}]'::jsonb, 'track');

INSERT INTO holdingsitemssolrkeys (AGENCYID, BIBLIOGRAPHICRECORDID, INDEXKEYS, TRACKINGID)
     VALUES ( 600, '600', '[{}, {}]'::jsonb, 'track');


INSERT INTO holdingsTobibliographic (holdingsagencyid,bibliographicagencyid, bibliographicrecordid, isCommonDerived ) VALUES (600, 100,'600', false);
