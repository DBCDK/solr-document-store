...
INSERT INTO holdingsitemssolrkeys (AGENCYID, BIBLIOGRAPHICRECORDID, HASLIVEHOLDINGS, INDEXKEYS, PRODUCERVERSION, TRACKINGID)
     VALUES ( 300, '4321', TRUE, '[{"id": ["argle"], "title": ["unix bogen"]}, {"id": ["argle"], "dyr": ["hest"], "title": ["unix bogen"]}]'::jsonb, 'revision','track');

INSERT INTO holdingsitemssolrkeys (AGENCYID, BIBLIOGRAPHICRECORDID, HASLIVEHOLDINGS, INDEXKEYS, PRODUCERVERSION, TRACKINGID)
     VALUES ( 600, '600', FALSE, '[{"id": ["argle"], "title": ["unix bogen"]}, {"id": ["argle"], "dyr": ["hest"], "title": ["unix bogen"]}]'::jsonb, 'revision','track');
